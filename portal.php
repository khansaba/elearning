				...
				<div class="col-md-4">
					<a href="<?php echo base_url.'faculty' ?>" class="portal-link">
						<div class="card card-widget widget-user">
			              ...
			              <div class="card-footer bg-info">
			                <div class="container">
			                	<p class="text-center text-white-50"><small><i>Click here to Faculty Side</i></small></p>
			                </div>
			              </div>
			            </div>
					</a>
					...
					<a href="<?php echo base_url.'student' ?>" class="portal-link">
						<div class="card card-widget widget-user">
			              ...
			              <div class="card-footer bg-info border-info">
			                <div class="container">
			                	<p class="text-center text-white-50"><small><i>Click here to Student Side</i></small></p>
			                </div>
			              </div>
			            </div>
					</a>
